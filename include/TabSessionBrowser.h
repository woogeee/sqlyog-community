...
#ifndef _TABSESSIONBROWSER_H_
#define _TABSESSIONBROWSER_H_

class TabSessionBrowser : public TabTypes
{
public:
	TabSessionBrowser(void);

	TabSessionBrowser(MDIWindow *wnd, HWND hwnd, wyBool issticky);
