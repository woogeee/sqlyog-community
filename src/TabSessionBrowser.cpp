...
TabSessionBrowser::TabSessionBrowser(MDIWindow *wnd, HWND hwndparent, wyBool issticky) :TabTypes(hwndparent)
{
	...
	m_tabledata =  new MySQLTableDataEx(wnd);
	m_tableview = wnd->m_pctabmodule->m_sessionview;
	
}


TabSessionBrowser::~TabSessionBrowser(void)
{
	delete m_tabledata;
}

wyInt32
TabSessionBrowser::CreateTab(wyBool issetfocus)
{
	wyInt32				count = 0;
	CTCITEM				item = { 0 };
	...
	if (m_istabsticky == wyTrue)
	{
		...
		*/
		buffer2.Sprintf("Session Browser");
...
wyBool
TabSessionBrowser::CloseTab(wyInt32 index)
{
...
VOID
TabSessionBrowser::ShowTabContent(wyInt32 tabindex, wyBool status)
{
...
void
TabSessionBrowser::Resize(wyBool issplittermoved)
{

}

VOID
TabSessionBrowser::OnTabSelChange()
{
...
VOID
TabSessionBrowser::OnTabSelChanging()
{

}

wyInt32
TabSessionBrowser::OnTabClosing(wyBool ismanual)
{
...
VOID
TabSessionBrowser::OnTabClose()
{
}

wyInt32
TabSessionBrowser::OnWmCloseTab()
{
	return 0;
}

void
TabSessionBrowser::GetCurrentSelection()
{

}

wyBool
TabSessionBrowser::FreeMySQLResources(wyBool isfreemyres)
{
	return wyTrue;
}

wyBool
TabSessionBrowser::ReExecute(wyInt32 action)
{
	return wyTrue;
}

VOID
TabSessionBrowser::HandleTabControls(wyInt32 tabcount, wyInt32 selindex)
{

}

VOID
TabSessionBrowser::HandleFlicker()
{
}

void
TabSessionBrowser::OnGetChildWindows(wyInt32 tabcount, LPARAM lparam)
{

}

wyBool
TabSessionBrowser::FreeItemData()
{
	wyBool			ret = wyFalse;
...
wyBool
TabSessionBrowser::FreeItemData(TABLEDATARES *tbldatares, wyBool isnewrow)
{
...
wyBool
TabSessionBrowser::ExecuteTableDataQuery()
{
...
void
TabSessionBrowser::SetBufferedDrawing(wyBool isset)
{
	if (m_tableview)
	{
